...
const embeddingModels = ref([
    ...
    { label: 'ollama/all-minilm', value: 'ollama/all-minilm', provider: 'ollama', used_in: 'ai-provider', exists: false },
    ...
    { label: 'ollama/snowflake-artic-embed', value: 'ollama/snowflake-artic-embed', provider: 'ollama', used_in: 'ai-provider', exists: false },
    ...
    { label: 'ollama/granite-embedding', value: 'ollama/granite-embedding', provider: 'ollama', used_in: 'ai-provider', exists: false },
